...
## Healt impact
Since we have over `r length(significantHealthEvType$VOLUME[significantHealthEvType$VOLUME>0])` values we will plot only top 15 values (after cleanup done in data processing).
